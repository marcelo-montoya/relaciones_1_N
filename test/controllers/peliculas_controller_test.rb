...
class PeliculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pelicula" do
    assert_difference("Pelicula.count") do
      post peliculas_url, params: { pelicula: { cliente_id: @pelicula.cliente_id, nombre: @pelicula.nombre } }
    end
  ...
  test "should update pelicula" do
    patch pelicula_url(@pelicula), params: { pelicula: { cliente_id: @pelicula.cliente_id, nombre: @pelicula.nombre } }
